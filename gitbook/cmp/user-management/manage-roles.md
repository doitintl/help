...
| Permissions           |  Admin  | Finance User | IT Manager | Power User | Standard User |
| --------------------- | :-----: | :----------: | :--------: | :--------: | :-----------: |
...
| Issues Viewer         | &check; |   &check;    |  &check;   |  &check;   |    &check;    |
| Settings Manager      | &check; |              |            |  &check;   |               |
| Sandbox Admin         | &check; |              |            |  &check;   |               |
| Sandbox User          | &check; |              |            |  &check;   |    &check;    |
| Spot0                 | &check; |              |            |  &check;   |               |
| Support Requester     | &check; |   &check;    |  &check;   |  &check;   |    &check;    |
