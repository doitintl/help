...
![A screenshot showing the Create Sandbox Project modal dialog](../../static/img/docs/cmp-create-sandbox-acct.png)

Once created, you will see your new sandbox project on the list.

<Image
  alt="A screenshot of the _Sandbox accounts_ screen with one sandbox"
  img={require('../../static/img/docs/cmp-sandbox-accounts.png')}
/>
