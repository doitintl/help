...
<Image
  ...
  img={require('../assets/cmp-sandbox-accounts-empty.png')}
/>
...
![A screenshot showing the location of the Sandbox Policy modal dialog Accept button](../assets/cmp-sandbox-policy-1.png)
...
![A screenshot showing the Sandbox Policy modal dialog](../assets/cmp-sandbox-policy-2.png)
