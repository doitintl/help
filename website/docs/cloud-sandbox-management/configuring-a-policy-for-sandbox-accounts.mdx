...
<Image
  ...
  img={require('../assets/png/cmp-sandbox-accounts-empty.png')}
/>
...
![A screenshot showing the location of the Sandbox Policy modal dialog Accept button](../assets/png/cmp-sandbox-policy-1.png)
...
![A screenshot showing the Sandbox Policy modal dialog](../assets/png/cmp-sandbox-policy-2.png)
