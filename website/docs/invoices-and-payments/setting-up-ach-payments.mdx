...
<Image
  ...
  img={require('../assets/cmp-payment-methods.png')}
/>
...
![A screenshot showing you the initial Plaid modal dialog with a Continue button](../assets/cmp-ach-2.png)

Next, choose your bank.

![A screenshot of the modal dialog showing you how to select your bank](../assets/cmp-ach-3.png)

Then enter the same credentials used for your online banking account.

![A screenshot of the modal dialog showing you how to enter your banking credentials](../assets/cmp-ach-4.png)

After that, choose either a 'Checking' or 'Saving' account.

![A screenshot of the modal dialog showing you the ability to select between a Checking or Savings account](../assets/cmp-ach-6.png)

Finally, your bank account details should successfully be linked and saved for future ACH Payments.

![A screenshot of the modal dialog showing you the final payment setup form](../assets/cmp-ach-7.png)

## Pay Invoice with ACH

The saved ACH method will be available when you want to pay for future invoices.

![A screenshot showing you a list of saved payment methods](../assets/cmp-ach-8.png)
