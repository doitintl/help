...
![A screenshot of the CMP dashboard](../assets/png/cmp-new-billing-profile-menu-item.png)

Selecting this menu item will take you to the _New Billing Profile_ page:

![A screenshot showing you the _New Billing Profile_ page](../assets/png/cmp-new-billing-profile-screen.png)
...
!["Invalid Accounts Payable email address"](../assets/png/cmp-invalid-account.png)
...
![A screenshot showing a notification email](../assets/png/email-payment-confirmation.png)
