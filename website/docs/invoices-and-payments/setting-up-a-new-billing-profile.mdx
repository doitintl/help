...
![A screenshot of the CMP dashboard](../../static/img/docs/cmp-new-billing-profile-menu-item.png)

Selecting this menu item will take you to the _New Billing Profile_ page:

![A screenshot showing you the _New Billing Profile_ page](../../static/img/docs/cmp-new-billing-profile-screen.png)
...
!["Invalid Accounts Payable email address"](../../static/img/docs/cmp-invalid-account.png)
...
![A screenshot showing a notification email](../../static/img/docs/email-payment-confirmation.png)
