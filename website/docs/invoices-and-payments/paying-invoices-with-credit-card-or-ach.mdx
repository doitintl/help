...
# Paying invoices with a credit card or ACH
...
![A screenshot of the _Invoices_ screen](../assets/png/cmp-invoices-screen.png)
...
![A screenshot showing you the _Pay with Credit Card_ modal dialog](../assets/png/cmp-pay-with-cc.png)
...
![A screenshot of the _Pay with Credit Card_ modal dialog showing previous credit cards on file](../assets/png/cmp-pay-credit-card-dialog.png)
