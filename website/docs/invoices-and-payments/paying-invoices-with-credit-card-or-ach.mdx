...
![A screenshot of the _Invoices_ screen](../../static/img/docs/cmp-invoices-screen.png)
...
![A screenshot showing you the _Pay with Credit Card_ modal dialog](../../static/img/docs/cmp-pay-with-cc.png)
...
![A screenshot of the _Pay with Credit Card_ modal dialog showing previous credit cards on file](../../static/img/docs/cmp-pay-credit-card-dialog.png)
