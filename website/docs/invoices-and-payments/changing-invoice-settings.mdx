...
![A screenshot of the _Invoice Settings_ screen](../assets/png/cmp-invoice-settings-screen.png)
...
![A screenshot showing you the custom bucketing option](../assets/png/cmp-invoice-custom-bucketing.png)
...
<LoomEmbed id="58349311a16d4daf8d9f9c5b1ebffdce" />
