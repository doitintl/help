...
![A screenshot of the _Invoice Settings_ screen](../../static/img/docs/cmp-invoice-settings-screen.png)
...
![A screenshot showing you the custom bucketing option](../../static/img/docs/cmp-invoice-custom-bucketing.png)
