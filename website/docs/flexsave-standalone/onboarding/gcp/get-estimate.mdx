...
You need a create a DoiT account to get a Flexsave estimate for your _Google Cloud Platform_ (GCP) savings.
...
1. Fill in your organization ID on the estimate screen.

   For how to find your organization ID, see [Google Cloud Docs](https://cloud.google.com/resource-manager/docs/creating-managing-organization#retrieving_your_organization_id).

   The code snippets will be updated automatically once the organization ID is provided.
...
1. Open the Google Cloud Shell, copy the command code snippets and run them in sequence in the shell.
   ...
   1. Add an IAM policy binding to associate the `doit_flexsave_role` to the service account.
