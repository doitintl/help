...
After signing in, select **Google Cloud Platform** for your estimate.

To calculate your potential savings, you need to grant permissions to the DoiT Flexsave service account at the organization level for it to fetch GCP recommendations.

1. Fill in your organization ID.

   See Google Cloud Docs for [Getting your organization ID](https://cloud.google.com/resource-manager/docs/creating-managing-organization#retrieving_your_organization_id). The code snippet will be updated automatically with the organization ID.
