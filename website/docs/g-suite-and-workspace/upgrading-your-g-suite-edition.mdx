...
![A screenshot showing the Google Workspace screen](../../static/img/docs/cmp-assets-google-workspace-screen.png)
...
![A screenshot showing the location of the Change G Suite Edition option](../../static/img/docs/cmp-change-g-suite-edition.png)
...
![A screenshot showing the _Change g Suite Edition modal dialog](../../static/img/docs/cmp-g-suite-business.png)

An email notification confirming your recent order will be sent to you.

![A screenshot showing a confirmation notification email](../../static/img/docs/email-upgrade-g-suite.png)
