...
![A screenshot showing the Configure Auto-Increase option](../assets/png/cmp-configure-auto-increase-option.png)
...
![A screenshot showing the Configure Auto-Increase modal dialog](../assets/png/cmp-configure-auto-increase-dialog.png)
