...
<Image
  ...
  img={require('../assets/cmp-configure-auto-increase-option.png')}
/>
...
![A screenshot showing the Configure Auto-Increase modal dialog](../assets/cmp-configure-auto-increase-dialog.png)
