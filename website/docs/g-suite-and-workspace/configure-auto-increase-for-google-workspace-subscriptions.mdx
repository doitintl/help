...
# Setting Google Workspace licenses to auto-increase
...
<picture
  img={require('../../assets/png/cmp-configure-auto-increase-option.png')}
...
<picture
  img={require('../../assets/png/cmp-configure-auto-increase-dialog.png')}
...
<video
  type="loom"
  id="be1b3ebbd165446799b53653487774e7"
  thumb="-00001.gif"
/>
