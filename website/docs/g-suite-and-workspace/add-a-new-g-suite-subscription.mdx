---
sidebar_position: 3
description: Add new subscriptions to your existing G Suite or Google Workspace account with DoiT International
---
...
![A screenshot showing the Google Workspace screen](../../static/img/docs/cmp-google-workspace-new.png)
