...
<picture
  img={require('../../assets/png/cmp-dashboard-add-new.png')}
...
<picture
  img={require('../../assets/png/cmp-dashboard-new-add-widgets.png')}
...
<picture
  img={require('../../assets/png/cmp-dashboard-new-example.png')}
