...
![A screenshot showing the _New Dashboard_ modal dialog](../assets/png/cmp-dashboard-add-new.png)
...
![A screenshot showing the location the widgets panel](../assets/png/cmp-dashboard-new-add-widgets.png)
...
![A screenshot showing an example dashboard](../assets/png/cmp-dashboard-new-example.png)
