...
<Image
  alt="A screenshot showing the _New Dashboard_ modal dialog"
  img={require('../../static/img/docs/cmp-dashboard-add-new.png')}
/>
...
<Image
  ...
  img={require('../../static/img/docs/cmp-dashboard-new-add-widgets.png')}
/>
...
<Image
  alt="A screenshot showing an example dashboard"
  img={require('../../static/img/docs/cmp-dashboard-new-example.png')}
/>
...
- [Accessing a public dashboard](accessing-a-public-dashboard.mdx)
