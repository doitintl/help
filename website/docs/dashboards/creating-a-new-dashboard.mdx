...
![A screenshot the default CMP dashboard](../../static/img/docs/cmp-dashboard.png)

Select the _New Dashboard_ button from the right-hand side of the dashboard navigation bar:

![A screenshot showing the _New Dashboard_ modal dialog](../../static/img/docs/cmp-dashboard-add-new.png)
...
![A screenshot showing the location the widgets panel](../../static/img/docs/cmp-dashboard-new-add-widgets.png)
...
![A screenshot showing an example dashboard](../../static/img/docs/cmp-dashboard-new-example.png)
