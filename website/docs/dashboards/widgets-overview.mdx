...
<Image
  alt="A screenshot showing the default dashboard"
...
![A screenshot showing the _Essential Contacts_ widget](../../static/img/docs/cmp-extended-team.png)
...
![A screenshot showing the _Billing Profiles_ widget](../../static/img/docs/cmp-billing-profiles.png)

## Latest Invoices

By clicking on the invoice number, you can quickly access the specific invoice.

![A screenshot showing the _Latest Invoices_ widget](../../static/img/docs/cmp-latest-invoices.png)

## Overdue Payments

View the overdue payments and see the total amount due in the top right-hand corner.

![A screenshot showing the _Overdue Payments_ widget](../../static/img/docs/cmp-overdue-payments.png)
...
![A screenshot showing the _Credits_ widget](../../static/img/docs/cmp-credits.png)
...
![A screenshot showing the _Licensing Activity_ widget](../../static/img/docs/cmp-license-activity-filter.png)
...
![A screenshot showing the _Support Requests_ widget](../../static/img/docs/cmp-support-requests.png)
...
![A screenshot showing the _Monthly Cloud Cost History_ widget for AWS](../../static/img/docs/cmp-aws.png)
...
![A screenshot showing the _Monthly Cloud Cost History_ widget for Google Cloud](../../static/img/docs/cmp-google-cloud.png)
...
![A screenshot showing the _Cloud Commitment_ widget](../../static/img/docs/cmp-cloud-commitments.png)
