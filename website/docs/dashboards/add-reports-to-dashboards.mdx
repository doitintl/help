...
![A screenshot highlighting the location of the _Add to dashboard_ icon](../../static/img/docs/cmp-dashboards-widgets-1.png)
...
![A screenshot showing the list of available dashboards](../../static/img/docs/cmp-dashboards-widgets-2.png)
...
![A screenshot showing you the location of the Save button](../../static/img/docs/cmp-new-dashboard.png)

Check the box of the newly-created dashboard to add your report there as well.

![A screenshot showing you the checkbox for your new dashboard](../../static/img/docs/cmp-new-dashboard-2.png)
...
![An animated screenshot demoing a dashboard widget](../../static/img/docs/cmp-dashboard-widget-demo.gif)
...
<LoomEmbed id="4f125260e1214c6f9b85002ca13e6ade" />
