...
<Image
  ...
  img={require('../assets/cmp-dashboards-widgets-1.png')}
/>
...
<Image
  ...
  img={require('../assets/cmp-dashboards-widgets-2.png')}
/>
...
![A screenshot showing you the location of the Save button](../assets/cmp-new-dashboard.png)

Check the box of the newly-created dashboard to add your report there as well.

![A screenshot showing you the checkbox for your new dashboard](../assets/cmp-new-dashboard-2.png)
...
<Image
  ...
  img={require('../assets/cmp-dashboard-widget-demo.gif')}
/>
