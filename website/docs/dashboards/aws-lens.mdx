...
![A screenshot showing the AWS Lens dashboard](../../static/img/docs/cmp-dashboard-aws-lens.png)
...
![A screenshot of the Cost By Service report widget](../../static/img/docs/cmp-aws-lens-widget-cost-by-service.png)

### Cost By Top AWS Accounts

Review the AWS costs per AWS account in your organization.

![A screenshot of the Cost By Top AWS Account report widget](../../static/img/docs/cmp-aws-lens-widget-cost-by-top-aws-account.png)

### Cost By Region

Focus on AWS costs by AWS region. Look out for unrecognized regions to avoid unexpected costs.

![A screenshot of the Cost By Region report widget](../../static/img/docs/cmp-aws-lens-widget-cost-by-region.png)

### S3 Cost by Bucket

Focus on your _Simple Storage System_ (S3) usage and monitor your costs with a breakdown by bucket name.

![A screenshot of the S3 Cost by Bucket report widget](../../static/img/docs/cmp-aws-lens-widget-s3-cost-by-bucket.png)

### S3 by Operation Type

Review your _Simple Storage System_ (S3) costs for the storage tier you're using.

![A screenshot of the S3 by Operation Type report widget](../../static/img/docs/cmp-aws-lens-widget-s3-operation-type.png)

### EBS by Volume Type

Gain insights into how your application is using the _Elastic Block Storage_ (EBS) with a breakdown by storage type.

![A screenshot of the EBS by Volume Type report widget](../../static/img/docs/cmp-aws-lens-widget-ebs-by-volume-type.png)

### Flexsave AWS

See a visual summary of your [Flexsave](../flexsave/overview.mdx) compute savings.

![A screenshot of the Flexsave AWS report widget](../../static/img/docs/cmp-aws-lens-widget-flexsave-aws.png)
