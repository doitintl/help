...
![A screenshot of the _Google Cloud_ settings screen](../assets/png/cmp-google-cloud-settings.png)
...
![A partial screenshot of the BigQuery Lens dashboard](../assets/png/cmp-dashboard-bigquery-lens.png)
...
![A screenshot highlighting the _Not yet allocated_ figure](../assets/png/cmp-not-yet-allocated.png)
