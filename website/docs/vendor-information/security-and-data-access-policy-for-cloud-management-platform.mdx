...
This document outlines what customer data Cloud Management Platform accesses, why, what data is stored, and how we do that.

In summary, we only access data required for Cloud Management Platform (CMP) functionality. We store and handle your data in a secure way, encrypted in transit and at rest. We do not provide the data to any 3rd party, with the exceptions required for core CMP functionality and listed below.

:::attention

If you're not using DoiT Cloud Management Platform for the following features, this article doesn't apply.
...
While this provides us permissions to read info about your resources, none of these allow us to access your data, such as GCS objects or a BigQuery data.
...
The following permission is required for [CMP Sandbox](../cloud-sandbox-management/create-gcp-sandbox-accounts.mdx) functionality (create Google Cloud projects)

```
resourcemanager.projects.create
```

The following permissions are required to provide you with [Rightsizing](../dashboards/rightsizing-for-google-cloud.mdx) Recommendations for your Google Compute Engine instances across your entire organization
...
The following set of permissions required for implementing [Rightsizing](../dashboards/rightsizing-for-google-cloud.mdx) recommendations:
...
The following permissions are required for the [BigQuery Lens Dashboard](../dashboards/bigquery-lens.mdx) to get actionable cost optimization recommendations for your Google BigQuery environment.
...
- **Assets created via using CMP** ([Invoices](../invoices-and-payments/managing-invoices.mdx), [Billing Profiles](../invoices-and-payments/setting-up-a-new-billing-profile.mdx), etc.) &mdash; required for core CMP functionality; stored in Firestore
