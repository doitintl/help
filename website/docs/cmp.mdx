...
- [Build customized reports](cloud-analytics/create-cloud-report/index.mdx) and [share](cloud-analytics/sharing-cloud-reports.mdx) them with others.
- Monitor costs on the go from your phone.
- [Detect trends](cloud-analytics/trend-analysis.mdx) in your cloud usage
