...
![A screenshot of the Feedback Hub showing a list of categories](../../static/img/docs/feedback-hub-categories.png)
...
![A screenshot showing the location of the Status icon](../../static/img/docs/feedback-hub-status-icon.png)
...
![A screenshot showing the voting modal dialog](../../static/img/docs/feedback-hub-voting-dialog.png)
