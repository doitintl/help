---
sidebar_position: 6
description: How to share your feedback and suggestions with the product team directly from the CMP
---
...
- [Feedback Hub](https://feedback.doit-intl.com) (share, view, and upvote your favorite ideas)
...
<picture
  img={require('../../assets/png/feedback-hub-categories.png')}
  alt="A screenshot of the Feedback Hub showing a list of categories"
/>
...
<picture
  img={require('../../assets/png/feedback-hub-status-icon.png')}
  alt="A screenshot showing the location of the Status icon"
/>
...
<picture
  img={require('../../assets/png/feedback-hub-voting-dialog.png')}
