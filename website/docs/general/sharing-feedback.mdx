...
![A screenshot of the Feedback Hub showing a list of categories](../assets/png/feedback-hub-categories.png)
...
![A screenshot showing the location of the Status icon](../assets/png/feedback-hub-status-icon.png)
...
![A screenshot showing the voting modal dialog](../assets/png/feedback-hub-voting-dialog.png)
