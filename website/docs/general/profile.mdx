...
![A  screenshot of the profile drop-down menu](../../static/img/docs/cmp-profile-drop-down.png)

The _Cloud Management Platform_ (CMP) will take you to your _Profile_ page:

![A screenshot of the _Profile_ screen](../../static/img/docs/cmp-profile.png)
...
![A screenshot of the _Permissions_ screen](../../static/img/docs/cmp-profile-permissions.png)
...
![A screenshot of the _Notifications_ screen](../../static/img/docs/cmp-profile-notifications.png)
...
![A screenshot of the _API_ screen](../../static/img/docs/cmp-profile-api.png)
