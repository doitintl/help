...
![A  screenshot of the profile drop-down menu](../assets/png/cmp-profile-drop-down.png)

The _Cloud Management Platform_ (CMP) will take you to your _Profile_ page:

![A screenshot of the _Profile_ screen](../assets/png/cmp-profile.png)
...
![A screenshot of the _Permissions_ screen](../assets/png/cmp-profile-permissions.png)
...
![A screenshot of the _Notifications_ screen](../assets/png/cmp-profile-notifications.png)
...
![A screenshot of the _API_ screen](../assets/png/cmp-profile-api.png)
