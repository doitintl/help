...
![A screenshot showing the _Slack_ settings page](../assets/png/cmp-settings-slack-create.png)
...
![A screenshot of an unfurled link in Slack](../assets/png/slack-link-unfurled.png)
...
![A screenshot showing the _Slack_ settings page](../assets/png/cmp-settings-slack-configure.png)
