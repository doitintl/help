...
<Image
  ...
  img={require('../assets/png/cmp-settings-slack-create.png')}
/>
...
<Image
  ...
  img={require('../assets/png/slack-link-unfurled.png')}
/>
...
<Image
  alt="A screenshot showing the _Slack_ settings page"
  img={require('../assets/png/cmp-settings-slack-configure.png')}
/>
