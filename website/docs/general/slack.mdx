...
<Image
  ...
  img={require('../../static/img/docs/cmp-settings-slack-create.png')}
/>
...
<Image
  ...
  img={require('../../static/img/docs/slack-link-unfurled.png')}
/>
...
<Image
  alt="A screenshot showing the _Slack_ settings page"
  img={require('../../static/img/docs/cmp-settings-slack-configure.png')}
/>
