...
![A screenshot of an example email](../../static/img/docs/email-company-registration.png)
...
There will be a section that requests your billing information. This does not activate billing, it just ensures that once the paperwork is signed, you don't experience any drop in service.
...
<LoomEmbed id="cdc521cedb0e443c9d1f464fd8d53d8c" />
