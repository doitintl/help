...
<Image
  ...
  img={require('../../static/img/docs/cmp-spot-scaling-checkbox.png')}
/>
...
<Image
  ...
  img={require('../../static/img/docs/cmp-spot-scaling-not-optimized.png')}
/>

Click on the ASG to view its Spot Scaling recommendation.

<Image
  alt="A screenshot showing the location of the ASG name"
  img={require('../../static/img/docs/cmp-spot-scaling-asg.png')}
/>
...
<Image
  ...
  img={require('../../static/img/docs/cmp-current-values-recommended-values.png')}
/>
