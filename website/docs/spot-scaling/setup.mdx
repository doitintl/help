...
If you've already linked your AWS account(s) to the CMP, go to [this step](#aws-account-previously-linked) instead.
...
![A screenshot showing the checkbox next to Spot Scaling](../../static/img/docs/cmp-spot-scaling-checkbox.png)
...
![A screenshot showing the location of the 'Not Optimized' status](../../static/img/docs/cmp-spot-scaling-not-optimized.png)

Click on the ASG to view its Spot Scaling recommendation.

![A screenshot showing the location of the ASG name](../../static/img/docs/cmp-spot-scaling-asg.png)
...
![A screenshot showing the location of the Current Values and Recommended Values sections](../../static/img/docs/cmp-current-values-recommended-values.png)
