...
<Image
  alt="A screenshot showing the _Perks_ page"
  img={require('../../static/img/docs/cmp-services-perks.png')}
/>
...
<Image
  alt="A screenshot showing a perks offer"
  img={require('../../static/img/docs/cmp-services-perks-offer.png')}
/>
