...
![A screenshot showing the _Training_ page](../../static/img/docs/cmp-services-training.png)
...
![A screenshot showing a training offer](../../static/img/docs/cmp-services-training-offer.png)
