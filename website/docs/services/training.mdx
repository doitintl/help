...
![A screenshot showing the _Training_ page](../assets/png/cmp-services-training.png)
...
![A screenshot showing a training offer](../assets/png/cmp-services-training-offer.png)
