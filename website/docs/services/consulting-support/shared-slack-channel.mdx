...
Our Slack application can enhance your Slack experience by automatically unfurling links to the CMP and providing metadata and rich previews for [Cloud Analytics reports](../../cloud-analytics/reports/index.mdx) and [budgets](../../cloud-analytics/manage-budgets.mdx).
