...
![A screenshot showing the _Consulting and support_ page](../../../static/img/docs/cmp-services-consulting-support.png)
...
You will not see an _ESCALATE_ button when viewing another user's ticket (see [ticket sharing](ticket-sharing.mdx)). Please contact the original user or reach out to your account manager for further assistance.
