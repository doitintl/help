...
![A screenshot showing the Attributions tab](../assets/png/cmp-attributions-screen.png)
...
![A screenshot showing the _Identity and access_ screen](../assets/png/cmp-iam-screen.png)

From this screen, select _Organizations_ from the left-hand menu:

![A screenshot showing the Organizations menu](../assets/png/cmp-iam-org-screen.png)

On this screen, select the _NEW ORGANIZATION_ button.

### Step 3. Configure your organization

![A screenshot showing the organization configuration screen](../assets/png/cmp-new-organization-screen.png)
