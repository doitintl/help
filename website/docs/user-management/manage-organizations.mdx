...
<picture
  img={require('../../assets/png/cmp-iam-org-screen.png')}
...
<picture
  img={require('../../assets/png/cmp-new-organization-screen.png')}
...
1. Only the Cloud Analytics feature supports Organizations today
   ...
   2. Savings features like [Flexsave](../flexsave/index.mdx) are reflective of the total company spend
