...
![A screenshot showing the location of the _Continue to editing user profile_ checkbox and the _Invite_ button](../assets/png/cmp-edit-user-profile-invite-button.png)
...
![A screenshot showing the _Bulk Update Users_ modal dialog"](../assets/png/cmp-bulk-update-dialog.png)
