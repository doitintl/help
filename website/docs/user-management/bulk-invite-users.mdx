...
To ensure your CSV file is structured properly, download the [bulk_upload_template.csv](../../assets/csv/bulk_upload_template.csv) file and use it to format your bulk invitations.
