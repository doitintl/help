...
![A screenshot of the _Identity and access_ screen](../../static/img/docs/cmp-iam-screen.png)

From there, select _Roles_ from the left-hand menu:

![A screenshot showing the _Roles_ screen_](../../static/img/docs/cmp-roles.png)
...
![A screenshot showing the _New role_ screen_](../../static/img/docs/cmp-permissions.png)
