---
sidebar_position: 2
description: User Roles allow you to group sets of permissions and assign them to the users in your organization.
---
...
If someone from your organization (as determined by their email address) signs up without [being invited](creating-a-new-user.mdx#inviting-new-users), their user account will be assigned your organization's [default role](#setting-a-default-role) (or the [Basic Role](#basic-role) if no default is configured).
...
| Cloud Analytics        | create new and access existing [Cloud Analytics reports](../cloud-analytics/reports/index.mdx) |
...
| Support              | create new and access existing technical support requests                                                                                            |
| Cloud Analytics      | create new and access existing [Cloud Analytics reports](../cloud-analytics/reports/index.mdx)                                                       |
| Sandbox User         | [create disposable cloud environments](../cloud-sandbox-management/create-gcp-sandbox-accounts.mdx) (sandboxes) governed by a company Sandbox policy |
| Sandbox Admin        | set company [Sandbox policy](../cloud-sandbox-management/configuring-a-policy-for-sandbox-accounts.mdx) for other users                              |
| Flexsave Admin       | purchase and manage [flexible reservations](../flexsave/index.mdx)                                                                                   |
...
<picture
  img={require('../../assets/png/cmp-roles.png')}
  alt="A screenshot showing the _Roles_ screen_"
/>
...
permissions](user-permissions-explained.mdx) available for you to group into the new role:

<picture
  img={require('../../assets/png/cmp-permissions.png')}
  alt="A screenshot showing the _New role_ screen_"
/>
