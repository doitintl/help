...
| Flexsave Admin       | purchase and manage [flexible reservations](../flexsave/overview.mdx)                                  |
...
<Image
  ...
  img={require('../../static/img/docs/cmp-iam-screen.png')}
/>
...
<Image
  ...
  img={require('../../static/img/docs/cmp-roles.png')}
/>
...
<Image
  ...
  img={require('../../static/img/docs/cmp-permissions.png')}
/>
...
[gcp-sandboxes]: ../cloud-sandbox-management/create-gcp-sandbox-accounts.mdx
[sandbox-policy]: ../cloud-sandbox-management/configuring-a-policy-for-sandbox-accounts.mdx
