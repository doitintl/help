...
<Image
  ...
  img={require('../assets/cmp-google-cloud-settings.png')}
/>
...
![A screenshot showing the process of granting the BigQuery Data Viewer role](../assets/gcp-grant-bigquery-role.png)
...
![A screenshot showing how to select an organization, access the IAM & Admin menu item, and then select Roles](../assets/gcp-iam-admin-select-roles.png)

![A screenshot showing the location of the service account listing](../assets/gcp-services-account-listing.png)

![A screenshot showing the location of the Edit Role option and the bigquery.jobs.create permission listing](../assets/gcp-edit-role-permission-listing.png)

<Image
  alt="A screenshot showing the Add Permissions option, a list of permissions, and the Add button"
  img={require('../assets/gcp-add-permissions.png')}
/>
...
<Image
  ...
  img={require('../assets/cmp-assets-google-cloud-link-direct-account.png')}
/>
...
![A screenshot showing the new Google Cloud card with a "Processing" status](../assets/cmp-google-cloud-card-processing.png)

![A screenshot showing the new Google Cloud card with a "Success" status](../assets/cmp-google-cloud-card-success.png)
