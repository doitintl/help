...
![A screenshot showing the _Google Cloud_ settings screen](../../static/img/docs/cmp-google-cloud-settings.png)
...
![A screenshot showing the location of the Share Dataset option](../../static/img/docs/gcp-share-dataset-button.png)

![A screenshot showing the process of granting the BigQuery Data Viewer role](../../static/img/docs/gcp-grant-bigquery-role.png)
...
![A screenshot showing how to select an organization, access the IAM & Admin menu item, and then select Roles](../../static/img/docs/gcp-iam-admin-select-roles.png)

![A screenshot showing the location of the service account listing](../../static/img/docs/gcp-services-account-listing.png)

![A screenshot showing the location of the Edit Role option and the bigquery.jobs.create permission listing](../../static/img/docs/gcp-edit-role-permission-listing.png)

![A screenshot showing the Add Permissions option, a list of permissions, and the Add button](../../static/img/docs/gcp-add-permissions.png)
...
![A screenshot showing the Google Cloud assets page](../../static/img/docs/cmp-assets-google-cloud.png)
...
![A screenshot showing the _Link Direct Account_ modal dialog](../../static/img/docs/cmp-assets-google-cloud-link-direct-account.png)
...
![A screenshot showing the new Google Cloud card with a "Processing" status](../../static/img/docs/cmp-google-cloud-card-processing.png)

![A screenshot showing the new Google Cloud card with a "Success" status](../../static/img/docs/cmp-google-cloud-card-success.png)
