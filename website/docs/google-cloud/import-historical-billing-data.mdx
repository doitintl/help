...
![A screenshot showing the _Google Cloud_ settings screen](../assets/png/cmp-google-cloud-settings.png)
...
![A screenshot showing the location of the Share Dataset option](../assets/png/gcp-share-dataset-button.png)

![A screenshot showing the process of granting the BigQuery Data Viewer role](../assets/png/gcp-grant-bigquery-role.png)
...
![A screenshot showing how to select an organization, access the IAM & Admin menu item, and then select Roles](../assets/png/gcp-iam-admin-select-roles.png)

![A screenshot showing the location of the service account listing](../assets/png/gcp-services-account-listing.png)

![A screenshot showing the location of the Edit Role option and the bigquery.jobs.create permission listing](../assets/png/gcp-edit-role-permission-listing.png)

![A screenshot showing the Add Permissions option, a list of permissions, and the Add button](../assets/png/gcp-add-permissions.png)
...
![A screenshot showing the Google Cloud assets page](../assets/png/cmp-assets-google-cloud.png)
...
![A screenshot showing the _Link Direct Account_ modal dialog](../assets/png/cmp-assets-google-cloud-link-direct-account.png)
...
![A screenshot showing the new Google Cloud card with a "Processing" status](../assets/png/cmp-google-cloud-card-processing.png)

![A screenshot showing the new Google Cloud card with a "Success" status](../assets/png/cmp-google-cloud-card-success.png)
