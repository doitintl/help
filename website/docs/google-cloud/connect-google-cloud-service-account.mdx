...
<Image
  alt="A screenshot showing the _Google Cloud_ settings menu item"
  img={require('../../static/img/docs/cmp-google-cloud-settings-menu.png')}
/>
...
<Image
  ...
  img={require('../../static/img/docs/gcp-gcloud-download-file.png')}
/>
...
<Image
  ...
  img={require('../../static/img/docs/gcp-created-doit-cmp-role.png')}
/>
