...
![A screenshot showing the _Google Cloud_ settings menu item](../assets/png/cmp-google-cloud-settings-menu.png)
...
![A screenshot showing the location of the Download File menu item](../assets/png/gcp-gcloud-download-file.png)
...
![A screenshot of a list of organization roles](../assets/png/gcp-created-doit-cmp-role.png)
