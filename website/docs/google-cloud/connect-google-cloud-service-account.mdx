...
![A screenshot showing the _Google Cloud_ settings menu item](../../static/img/docs/cmp-google-cloud-settings-menu.png)
...
![A screenshot showing the location of the Download File menu item](../../static/img/docs/gcp-gcloud-download-file.png)
...
![A screenshot of a list of organization roles](../../static/img/docs/gcp-created-doit-cmp-role.png)
...
<LoomEmbed id="55c2fd9dbde74ac6bd2d3ac7e8c8bd45" />
