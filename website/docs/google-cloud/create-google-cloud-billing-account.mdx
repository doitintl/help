...
![A screenshot showing the _New Billing Account_ modal dialog](../../static/img/docs/cmp-assets-google-cloud-new-billing-account.png)
...
<LoomEmbed id="c2b1e2fe55204fa9aa7bafe7a3cc8c06" />
