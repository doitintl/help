...
![A screenshot showing the CMP dashboard](../../../static/img/docs/cmp-dashboard.png)

From the _Assets_ screen, select the _Google Cloud_ menu option from the left-hand menu:

![A screenshot showing the _Google Cloud_ assets screen](../../../static/img/docs/cmp-assets-google-cloud.png)
...
![A screenshot showing the location of the Transfer Projects option](../../../static/img/docs/cmp-transfer-project-menu-item.png)

Acknowledge the Marketplace Apps consent and click "Start":

![A screenshot showing the start of the Transfer Projects flow](../../../static/img/docs/cmp-transfer-gcp.png)
...
![A screenshot showing the Edit your IAM section of the Transfer Projects flow](../../../static/img/docs/cmp-transfer-projects-3.png)
...
![A screenshot showing the location of the expand icon for viewing the CLI commands](../../../static/img/docs/cmp-cli-commands-expand-icon.png)
...
![A screenshot showing you how to access the Add Member button](../../../static/img/docs/gcp-add-member-button.png)

![A screenshot showing you the Add members form](../../../static/img/docs/gcp-add-members-form.png)
...
![A screenshot showing you the location of the Billing navigation menu item](../../../static/img/docs/gcp-billing-menu-item.png)

Next, click on "**Manage Billing Accounts**"

![A screenshot showing you the location of the Manage Billing Accounts button](../../../static/img/docs/gcp-manage-billing-accounts-button.png)

Make sure your organization is selected. Then select the billing account you want to edit.

![A screenshot showing you the list of billing accounts to select from](../../../static/img/docs/gcp-billing-accounts-list.png)

In the Billing Overview screen, select "Manage" on the right.

![A screenshot showing you the location of the Manage option](../../../static/img/docs/gcp-billing-account-card.png)

Then, click the "**Show Info**" panel at the top-right to manage billing account members. From there, click "**Add Member**".

![A screenshot showing you how to access to the Add Member button](../../../static/img/docs/gcp-add-member-project-transfer.png)
...
![A screenshot showing you the list of available billing accounts](../../../static/img/docs/cmp-transfer-projects-6.png)
...
![A screenshot showing you the list of projects for review](../../../static/img/docs/cmp-transfer-projects-7.png)
...
![A screenshot showing you the final confirmation screen](../../../static/img/docs/cmp-transfer-projects-8.png)
...
![A screenshot showing you final screen when only some projects were transferred](../../../static/img/docs/cmp-transfer-wizard-partially-transferred.png)

If none of your projects were successfully transferred, you will see this message.

![A screenshot showing you the final screen when none of your projects were transferred](../../../static/img/docs/cmp-transfer-wizard-transfer-failure.png)
...
<LoomEmbed id="35299f0634e849a2821155c7488faedd" />
