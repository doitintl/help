...
<Image
  ...
  img={require('../../assets/cmp-assets-google-cloud.png')}
/>
...
<Image
  ...
  img={require('../../assets/cmp-transfer-project-menu-item.png')}
/>
...
<Image
  ...
  img={require('../../assets/cmp-transfer-gcp.png')}
/>
...
<Image
  ...
  img={require('../../assets/cmp-transfer-projects-3.png')}
/>
...
<Image
  ...
  img={require('../../assets/cmp-cli-commands-expand-icon.png')}
/>
...
<Image
  ...
  img={require('../../assets/gcp-add-member-button.png')}
/>

<Image
  alt="A screenshot showing you the Add members form"
  img={require('../../assets/gcp-add-members-form.png')}
/>
...
![A screenshot showing you the location of the Billing navigation menu item](../../assets/gcp-billing-menu-item.png)

Next, click on "**Manage Billing Accounts**"

![A screenshot showing you the location of the Manage Billing Accounts button](../../assets/gcp-manage-billing-accounts-button.png)

Make sure your organization is selected. Then select the billing account you want to edit.

![A screenshot showing you the list of billing accounts to select from"](../../assets/gcp-billing-accounts-list.png)

In the Billing Overview screen, select "Manage" on the right.

<Image
  alt="A screenshot showing you the location of the Manage option"
  img={require('../../assets/gcp-billing-account-card.png')}
/>

Then, click the "**Show Info**" panel at the top-right to manage billing account members. From there, click "**Add Member**".

![A screenshot showing you how to access to the Add Member button](../../assets/gcp-add-member-project-transfer.png)
...
<Image
  ...
  img={require('../../assets/cmp-transfer-projects-6.png')}
/>
...
<Image
  ...
  img={require('../../assets/cmp-transfer-projects-7.png')}
/>
...
<Image
  ...
  img={require('../../assets/cmp-transfer-projects-8.png')}
/>
...
<Image
  ...
  img={require('../../assets/cmp-transfer-wizard-partially-transferred.png')}
/>
...
<Image
  ...
  img={require('../../assets/cmp-transfer-wizard-transfer-failure.png')}
/>
