...
<Image
  ...
  img={require('../../../static/img/docs/cmp-assets-google-cloud.png')}
/>
...
<Image
  ...
  img={require('../../../static/img/docs/cmp-transfer-project-menu-item.png')}
/>
...
<Image
  ...
  img={require('../../../static/img/docs/cmp-transfer-gcp.png')}
/>
...
<Image
  ...
  img={require('../../../static/img/docs/cmp-transfer-projects-3.png')}
/>
...
<Image
  ...
  img={require('../../../static/img/docs/cmp-cli-commands-expand-icon.png')}
/>
...
<Image
  ...
  img={require('../../../static/img/docs/gcp-add-member-button.png')}
/>

<Image
  alt="A screenshot showing you the Add members form"
  img={require('../../../static/img/docs/gcp-add-members-form.png')}
/>
...
<Image
  ...
  img={require('../../../static/img/docs/gcp-billing-account-card.png')}
/>
...
<Image
  ...
  img={require('../../../static/img/docs/cmp-transfer-projects-6.png')}
/>
...
<Image
  ...
  img={require('../../../static/img/docs/cmp-transfer-projects-7.png')}
/>
...
<Image
  ...
  img={require('../../../static/img/docs/cmp-transfer-projects-8.png')}
/>
...
<Image
  ...
  img={require('../../../static/img/docs/cmp-transfer-wizard-partially-transferred.png')}
/>
...
<Image
  ...
  img={require('../../../static/img/docs/cmp-transfer-wizard-transfer-failure.png')}
/>
