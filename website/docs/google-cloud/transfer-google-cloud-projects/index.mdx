...
<LoomEmbed id="95ddb117ff974cc88553f1fd6efead85" />

## Transferring manually

If you have several dozens of GCP projects or less, the simplest way is to switch billing manually for each of the projects one by one. We've created screenshot-illustrated [guide](transfer-manually.mdx) to walk you through.
...
Please follow the guide [here](bulk-transfer-using-wizard.mdx).
...
Please follow the steps from the [illustrated-guide](terraform.mdx).
