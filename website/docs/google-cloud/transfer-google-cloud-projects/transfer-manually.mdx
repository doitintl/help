...
![A screenshot showing you the organization selection menu and the billing account list](../../../static/img/docs/gcp-organization-menu-billing-account-list.png)

- Click on Manage

![A screenshot showing the location of the Manager option](../../../static/img/docs/gcp-manager-option.png)
...
![A screenshot showing the location of the Change Billing option](../../../static/img/docs/gcp-change-billing-option.png)

- In the popup modal, please select the new billing account provided to you by DoiT International

![A screenshot showing you the billing account dropdown menu](../../../static/img/docs/gcp-billing-account-menu.png)
...
![A screenshot showing you how to access the list of transferred projects](../../../static/img/docs/gcp-access-transferred-projects.png)
...
![A screenshot showing you how to verify you have access to the billing account](../../../static/img/docs/cmp-verify-access-billing-account.png)
