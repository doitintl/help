...
![A screenshot showing you the organization selection menu and the billing account list](../../assets/gcp-organization-menu-billing-account-list.png)
...
<Image
  ...
  img={require('../../assets/gcp-manager-option.png')}
/>
...
![A screenshot showing the location of the Change Billing option](../../assets/gcp-change-billing-option.png)

- In the popup modal, please select the new billing account provided to you by DoiT International

![A screenshot showing you the billing account dropdown menu](../../assets/gcp-billing-account-menu.png)
...
![A screenshot showing you how to access the list of transferred projects](../../assets/gcp-access-transferred-projects.png)
...
![A screenshot showing you how to verify you have access to the billing account](../../assets/cmp-verify-access-billing-account.png)
