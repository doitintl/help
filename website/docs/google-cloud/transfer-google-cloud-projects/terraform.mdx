...
2. Open the Cloud Console Navigation menu, and then select **Billing**.
   ...
   <picture
     img={require('../../../assets/png/gcp-you-have-multiple-billing-accounts.png')}
...
3. In the Billing navigation menu, click **Account management**.
   ...
   <picture
     img={require('../../../assets/png/gcp-terraform-billing-menu.png')}
...
5. Click **Add Principal**
   ...
   <picture
     img={require('../../../assets/png/gcp-add-principal-button.png')}
     alt="A screenshot showing the location of the ADD PRINCIPAL button"
   />

6. Input the terraform service account as **New Principal** and select **`Billing Account User`** role, then Save.

   <picture
     img={require('../../../assets/png/gcp-add-principals-and-roles-form.png')}
     alt="A screenshot of the Add principals and roles form"
   />

:::attention Default Billing Account
