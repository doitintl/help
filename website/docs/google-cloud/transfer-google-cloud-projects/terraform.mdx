...
2. Open the Cloud Console Navigation menu, and then select **Billing**.
   ...
   ![A screenshot of the You have multiple billing accounts message](../../assets/gcp-you-have-multiple-billing-accounts.png)

3. In the Billing navigation menu, click **Account management**.

   ![A screenshot of the Billing menu](../../assets/gcp-terraform-billing-menu.png)
...
5. Click **Add Principal**
   ...
   ![A screenshot showing the location of the ADD PRINCIPAL button](../../assets/gcp-add-principal-button.png)

6. Input the terraform service account as **New Principal** and select **`Billing Account User`** role, then Save.

   ![A screenshot of the Add principals and roles form](../../assets/gcp-add-principals-and-roles-form.png)
