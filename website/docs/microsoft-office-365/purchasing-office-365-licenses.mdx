...
<picture
  img={require('../../assets/png/cmp-ms-office-365.png')}
...
<picture
  img={require('../../assets/png/cmp-office-license.png')}
  alt="A screenshot showing you the location of the Approve option"
/>
