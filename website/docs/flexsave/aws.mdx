...
Note that for customers with dedicated billing accounts, _unused_ capacity reservations are eligible for Flexsave discounts, similar to how they are handled under AWS savings plans.
