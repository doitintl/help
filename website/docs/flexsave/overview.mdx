...
![A screenshot of the Flexsave dashboard inviting you to start saving](../../static/img/docs/cmp-flexsave-start-saving.png)
...
![An example screenshot of the Flexsave dashboard](../../static/img/docs/cmp-flexsave.png)
