...
To provide the additional access needed for Flexsave to work, we have prepared a another template CloudFormation stack stack for you to create.
...
import YAML from './_flexsave_create_policies.yml.mdx';
