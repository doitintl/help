...
import SetUpBilling from '../_set-up-billing.mdx';
...
After selecting **SET UP FLEXSAVE**, you will be presented with the _DoiT International Flexsave Agreement_.
...
1. Open the Google Cloud Shell, copy the command code snippets and run them in sequence in the shell.
   ...
   1. Grant DoiT service account permission to attach projects with optimal CUDs to your Cloud Billing account.
      ...
      gcloud iam roles update doit_flexsave_role \
          ...
          --stage=GA \
          --add-permissions=billing.accounts.get,bigquery.jobs.create,billing.resourceAssociations.create,resourcemanager.projects.createBillingAssignment
      ```
      ...
      <dl>
        ...
        <dt>
          ...
          <code>resourcemanager.projects.createBillingAssignment</code>
        </dt>
