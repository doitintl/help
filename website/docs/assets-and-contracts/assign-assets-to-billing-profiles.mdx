...
4. Select _Billing Profile Assignment_ from the drop-down menu:
   ...
   ![A screenshot showing the asset drop-down menu](../assets/png/cmp-assets-drop-down-menu.png)

   The CMP will open a new modal dialog:

   ![A screenshot showing the _Billing Profile Assignment_ modal dialog](../assets/png/cmp-assets-billing-profile-modal.png)
