...
You can assign assets to [Billing Profiles](../invoices-and-payments/setting-up-a-new-billing-profile.mdx) for invoicing purposes. Since every Billing Profile receives its own monthly invoice, how you assign assets will affect how each entity is billed.
...
4. Select _Billing Profile Assignment_ from the drop-down menu:
   ...
   <picture
     img={require('../../assets/png/cmp-assets-billing-profile-modal.png')}
     alt="A screenshot showing the _Billing Profile Assignment_ modal dialog"
   />
