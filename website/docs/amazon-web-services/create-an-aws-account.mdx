...
<Image
  ...
  img={require('../assets/cmp-assets-aws-create-account-modal.png')}
/>
...
![Account created successfully! Check your email for further instructions](../assets/cmp-aws-account-successful.png)

The CMP will send you an email with further instructions. For example:

<Image
  alt="A screenshot of a _New Account_ email"
  img={require('../assets/email-aws-create-2.png')}
/>
