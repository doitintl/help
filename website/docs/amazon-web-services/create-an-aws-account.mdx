...
![A screenshot showing the _Create Account__ modal dialog](../assets/png/cmp-assets-aws-create-account-modal.png)
...
![Account created successfully! Check your email for further instructions](../assets/png/cmp-aws-account-successful.png)

The CMP will send you an email with further instructions. For example:

![A screenshot of a _New Account_ email](../assets/png/email-aws-create-2.png)
