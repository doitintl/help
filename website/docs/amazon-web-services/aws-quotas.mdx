...
!["Elastic IP address could not be allocated."](../assets/png/aws-elastic-ip.png)
...
![A screenshot showing the location the widgets panel](../assets/png/cmp-dashboard-add-widgets.png)
...
![A screenshot of the quotas widget](../assets/png/cmp-aws-quotas-widget.png)
