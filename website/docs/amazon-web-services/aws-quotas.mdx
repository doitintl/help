...
!["Elastic IP address could not be allocated."](../assets/aws-elastic-ip.png)
...
<Image
  ...
  img={require('../assets/cmp-dashboard-add-widgets.png')}
/>
...
![A screenshot of the quotas widget](../assets/cmp-aws-quotas-widget.png)
