---
sidebar_position: 3
description: Unlock additional Cloud Management Platform features by linking your AWS account
---
...
- [How to set up CloudHealth IAM role](https://www.cloudhealthtech.com/blog/cloud-governance-aws-iam-permissions)
...
<Image
  alt="A screenshot showing the location of the _Link Amazon Web Services_ button"
  img={require('../../static/img/docs/cmp-aws-link-account.png')}
/>
...
<Image
  alt="A screenshot showing the location of the _Link Amazon Web Services_ button"
  img={require('../../static/img/docs/cmp-aws-link-account-options.png')}
/>
...
<Image
  alt="A screenshot showing an expanded feature section"
  img={require('../../static/img/docs/cmp-aws-link-account-features.png')}
/>
...
<Image
  alt="A screenshot of the AWS CloudFormation modal dialog"
  img={require('../../static/img/docs/cmp-aws-link-account-stack-creation-modal.png')}
/>
...
<Image
  alt="A screenshot CLI Instructions modal dialog"
  img={require('../../static/img/docs/cmp-aws-link-account-cli-modal.png')}
/>
...
<Image
  alt="A screenshot of the manual role creation form"
  img={require('../../static/img/docs/cmp-aws-link-account-manual-role.png')}
/>
...
<Image
  ...
  img={require('../../static/img/docs/aws-go-to-roles.png')}
/>
...
<Image
  alt="A screenshot of AWS IAM"
  img={require('../../static/img/docs/aws-linking-aws-5.png')}
/>
...
<Image
  ...
  img={require('../../static/img/docs/aws-create-policy-in-role.png')}
/>
...
<Image
  alt="A screenshot of the AWS _Create policy_ page"
  img={require('../../static/img/docs/aws-linking-aws-6.png')}
/>
...
<Image
  alt="A screenshot of the policy name"
  img={require('../../static/img/docs/aws-linking-8.png')}
/>

##### [Quota Monitoring](aws-quotas.mdx)
...
<Image
  alt="A screenshot of the first step in the _Create policy_ flow"
  img={require('../../static/img/docs/aws-linking-8.png')}
/>
...
<Image
  alt="A screenshot of the third step in the AWS _Create policy_ flow"
  img={require('../../static/img/docs/aws-linking-9.png')}
/>
...
!["doit_intl_quotas has been created"](../../static/img/docs/cmp-doit-intl-quotas-created.png)
...
<Image
  alt="A screenshot of the second step in the AWS _Create role_ flow"
  img={require('../../static/img/docs/aws-create-role-2.png')}
/>

Give the Role an identifiable name (ex. 'doit-intl-cmp-role'), review the selected policies, and click on "**Create role**".

<Image
  alt="A screenshot of the fourth step in the AWS _Create role_ flow"
  img={require('../../static/img/docs/aws-create-role-4.png')}
/>
...
<Image
  alt="A screenshot of the AWS role summary page"
  img={require('../../static/img/docs/aws-roles-summary-screen.png')}
/>

Finally, copy and paste the Role ARN to the Cloud Management Platform and click 'Add'.

<Image
  alt="A screenshot highlighting the location to paste the _Role ARN_ value"
  img={require('../../static/img/docs/cmp-paste-role-arn-input.png')}
/>
...
<Image
  alt="A screenshot highlighting the status of the AWS account"
  img={require('../../static/img/docs/cmp-aws-account-status.png')}
/>
...
<Image
  alt="A screenshot highlighting the location of the _Unlink_ button"
  img={require('../../static/img/docs/cmp-account-unlink-button.png')}
/>
...
<Image
  alt="A screenshot highlighting the location of the _Edit_ button"
  img={require('../../static/img/docs/cmp-account-edit-button.png')}
/>

Then, check the box of any new feature(s) you'd like to add permissions for.

<Image
  alt="A screenshot showing a list of features"
  img={require('../../static/img/docs/cmp-add-feature-permissions.png')}
/>

There are two options for updating your role:

1. [Creating a stack in CloudFormation](link-account.mdx#option-1-create-stack-in-cloudformation)
2. [Copy + Pasting a command in CloudShell](link-account.mdx#option-2-create-role-via-cli)
...
<LoomEmbed id="ed483a87c6474c22ae735ec7d19e2215" />
