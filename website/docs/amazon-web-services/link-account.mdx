...
![A screenshot showing the location of the _Link Amazon Web Services_ button](../../static/img/docs/cmp-aws-link-account.png)
...
![A screenshot showing the location of the _Link Amazon Web Services_ button](../../static/img/docs/cmp-aws-link-account-options.png)
...
![A screenshot showing an expanded feature section](../../static/img/docs/cmp-aws-link-account-features.png)
...
![A screenshot of the AWS CloudFormation modal dialog](../../static/img/docs/cmp-aws-link-account-stack-creation-modal.png)
...
![A screenshot CLI Instructions modal dialog](../../static/img/docs/cmp-aws-link-account-cli-modal.png)
...
![A screenshot of the manual role creation form](../../static/img/docs/cmp-aws-link-account-manual-role.png)
...
![A screenshot showing the location of the Roles menu item](../../static/img/docs/aws-go-to-roles.png)
...
![A screenshot of AWS IAM](../../static/img/docs/aws-linking-aws-5.png)
...
![A screenshot showing the location of the Create policy button](../../static/img/docs/aws-create-policy-in-role.png)
...
![A screenshot of the AWS _Create policy_ page](../../static/img/docs/aws-linking-aws-6.png)
...
![A screenshot of the policy name](../../static/img/docs/aws-linking-8.png)
...
![A screenshot of the first step in the _Create policy_ flow](../../static/img/docs/aws-linking-8.png)
...
![A screenshot of the third step in the AWS _Create policy_ flow](../../static/img/docs/aws-linking-9.png)
...
![A screenshot of the second step in the AWS _Create role_ flow](../../static/img/docs/aws-create-role-2.png)

Give the Role an identifiable name (ex. 'doit-intl-cmp-role'), review the selected policies, and click on "**Create role**".

![A screenshot of the fourth step in the AWS _Create role_ flow](../../static/img/docs/aws-create-role-4.png)
...
![A screenshot of the AWS role summary page](../../static/img/docs/aws-roles-summary-screen.png)

Finally, copy and paste the Role ARN to the Cloud Management Platform and click 'Add'.

![A screenshot highlighting the location to paste the _Role ARN_ value](../../static/img/docs/cmp-paste-role-arn-input.png)
...
![A screenshot highlighting the status of the AWS account](../../static/img/docs/cmp-aws-account-status.png)
...
![A screenshot highlighting the location of the _Unlink_ button](../../static/img/docs/cmp-account-unlink-button.png)
...
![A screenshot highlighting the location of the _Edit_ button](../../static/img/docs/cmp-account-edit-button.png)

Then, check the box of any new feature(s) you'd like to add permissions for.

![A screenshot showing a list of features](../../static/img/docs/cmp-add-feature-permissions.png)
