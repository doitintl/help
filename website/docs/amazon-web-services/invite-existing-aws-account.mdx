...
![A screenshot showing the _Invite Account_ modal dialog](../../static/img/docs/cmp-assets-aws-invite-account-modal.png)
...
![A screenshot of an email sent by DoiT](../../static/img/docs/email-invite-existing-3.png)
...
![A screenshot of the AWS _Invitations_ screen](../../static/img/docs/aws-invite-4.png)
...
![A screenshot of an email sent by DoiT](../../static/img/docs/email-invite-5.png)
...
![A screenshot of the _AWS Organizations_ page](../../static/img/docs/aws-invite-6.png)
