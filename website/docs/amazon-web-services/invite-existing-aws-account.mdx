...
<Image
  ...
  img={require('../../static/img/docs/cmp-assets-aws.png')}
/>
...
<Image
  ...
  img={require('../../static/img/docs/cmp-assets-aws-invite-account-modal.png')}
/>
...
<Image
  alt="A screenshot of an email sent by DoiT"
  img={require('../../static/img/docs/email-invite-existing-3.png')}
/>
...
<Image
  ...
  img={require('../../static/img/docs/aws-invite-4.png')}
/>
...
<Image
  alt="A screenshot of an email sent by DoiT"
  img={require('../../static/img/docs/email-invite-5.png')}
/>
...
<Image
  alt="A screenshot of the _AWS Organizations_ page"
  img={require('../../static/img/docs/aws-invite-6.png')}
/>
...
![CloudHealth Status: Unknown](../../static/img/docs/cmp-cloudhealth-status-unknown.png)
...
2. Within the CMP, please open a [support request](../services/consulting-support/index.mdx) requesting that we backfill your data. You will need to provide access to the S3 buckets where the cost and usage report files are stored along with the associated `manifest.json` file.
