...
![Inviting a user in Setup > Users is not possible when SSO is enabled results in an error](../assets/png/cloudhealth-setup-users-error.png)

![SSO in Cloudhealth](../assets/png/cloudhealth-sso.png)
