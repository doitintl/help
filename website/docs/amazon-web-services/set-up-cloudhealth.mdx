...
![Inviting a user in Setup > Users is not possible when SSO is enabled results in an error](../assets/cloudhealth-setup-users-error.png)

import Image from '@theme/IdealImage';

<Image
  alt="SSO in Cloudhealth"
  img={require('../assets/cloudhealth-sso.png')}
/>
