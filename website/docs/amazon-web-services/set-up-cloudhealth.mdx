...
Follow the instructions below to set up [CloudHealth](https://www.cloudhealthtech.com) for your new or existing AWS account linked to DoiT International consolidated billing.
...
<picture
  img={require('../../assets/png/cloudhealth-setup-users-error.png')}
  alt="Inviting a user in Setup > Users is not possible when SSO is enabled results in an error"
/>

<picture
  img={require('../../assets/png/cloudhealth-sso.png')}
  alt="SSO in Cloudhealth"
/>

:::seealso

- [AWS Single Sign-On Service Integration Guide For CloudHealth](https://www.cloudhealthtech.com/blog/aws-single-sign-on-service-integration-guide-for-cloudhealth)
