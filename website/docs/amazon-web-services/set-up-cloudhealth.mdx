...
![Inviting a user in Setup > Users is not possible when SSO is enabled results in an error](../../static/img/docs/cloudhealth-setup-users-error.png)

![SSO in Cloudhealth](../../static/img/docs/cloudhealth-sso.png)
