...
- AWS customers with dedicated billing accounts will see AWS accounts with 3-year Saving Plans and names like `fs-xxxxx` attached to your AWS organization. See the [AWS FAQ](flexsave/aws.mdx#what-changes-should-i-expect-to-see-in-my-aws-console) for more information.

- GCP customers will see projects with 3-year committed use discounts and names like `doitintl-fs-xxxxxxx` attached to your billing account. See the [GCP FAQ](flexsave/gcp.mdx#what-changes-should-i-expect-to-see-in-my-google-cloud-console) for more information.
...
- [Flexsave for AWS: FAQs](flexsave/aws.mdx#faqs)
- [Flexsave for GCP: FAQs](flexsave/gcp.mdx#faqs)
