...
<Image
  alt="A screenshot showing the Identity and access screen"
...
<Image
  alt="A screenshot showing the Notifications screen"
  img={require('../../static/img/docs/cmp-notifications.png')}
/>
...
[Read more about attributions here](../cloud-analytics/attributing-cloud-spend.mdx#edit-settings)
...
<LoomEmbed id="c5005c6d4af9468f9df0b00ca5f43655" />
