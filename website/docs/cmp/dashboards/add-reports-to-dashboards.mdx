...
Adding [Cloud Analytics Reports](../cloud-analytics/create-cloud-report/) into [customizable dashboards](customizing-dashboards.mdx) gives you an at-a-glance view of your most important cloud infrastructure data points.
