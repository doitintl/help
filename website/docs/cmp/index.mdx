...
The DoiT International's _Cloud Management Platform_ (CMP) helps the developers and system administrators at digital-native companies improve cloud operations, maintain security, control cost, and ensure governance of its cloud estate.
...
| ------------------------------------------------------------------------- | --------------------------------------------------------------- | --------------------------------------- | ----- |
| **CloudOps**                                                              |                                                                 |                                         |       |
| [Consulting and support](cmp/services/consulting-support/)                | Yes                                                             | Yes                                     | Yes   |
| [Cloud known issues](cmp/services/consulting-support/cloud-incidents.mdx) | Yes                                                             | Yes                                     | No    |
| [Sandboxes](./#cloud-sandboxes)                                           | Yes                                                             | No                                      | No    |
| [Governance](./#cloud-governance)                                         | Yes                                                             | Yes                                     | No    |
| **Costs analysis and optimization**                                       |                                                                 |                                         |       |
| Lenses                                                                    | [BigQuery Lens](cmp/dashboards/bigquery-lens.mdx),<br/>GKE Lens | [AWS Lens](cmp/dashboards/aws-lens.mdx) | No    |
| [Cost history widgets](cmp/dashboards/widgets-overview.mdx)               | Yes                                                             | Yes                                     | Yes   |
| [Cloud analytics](./#cloud-analytics)                                     | Yes                                                             | Yes                                     | No    |
| [Costs anomalies](./#cost-anomalies)                                      | Yes                                                             | Yes                                     | No    |
| [Flexsave](cmp/flexsave/overview.mdx)                                     | Yes                                                             | Yes                                     | No    |
| [EC2 Spot Scaling](cmp/spot-scaling/overview.mdx)                         | N/A                                                             | Yes                                     | N/A   |
...
- [Build customized reports](cmp/cloud-analytics/create-cloud-report/) and [share](cmp/cloud-analytics/sharing-cloud-reports.mdx) them with others.
- Monitor costs on the go from your phone.
- [Detect trends](cmp/cloud-analytics/trend-analysis.mdx) in your cloud usage
- [Forecast your cloud spend](cmp/cloud-analytics/forecasting.mdx) across all time ranges and any cloud services
- Cross-check your SUD/CUD credits with by-the-hour reporting.

import LoomEmbed from '@site/src/components/LoomEmbed';

<LoomEmbed id="3bb89b9c624a4a52a2ecfbb61a56b4b8" />
...
- [Identify and delete and/or modify idle VMs](cmp/dashboards/rightsizing-for-google-cloud.mdx) in two clicks.
...
<LoomEmbed id="b3a232a312c24735aead19d02df4c50f" />
...
As a result, we created the [BigQuery Lens Dashboard](cmp/dashboards/bigquery-lens.mdx), your Swiss Army knife for highlighting inefficiencies in your team's BigQuery usage.
...
First, [create a sandbox policy](cmp/cloud-sandbox-management/configuring-a-policy-for-sandbox-accounts.mdx) to automate sandbox management. With a policy set up, you can:
...
Once a policy is created, developers are free to [create cloud sandbox environments](cmp/cloud-sandbox-management/create-gcp-sandbox-accounts.mdx) themselves. No more submitting tickets just to get a new environment provisioned by an SRE. Finally, when sandboxes are up and running, you can monitor them all from a central hub.

<LoomEmbed id="2e2adffc48464c0189b87e4750e7b7d3" />
...
With Quota Monitoring for [Google Cloud](cmp/google-cloud/google-cloud-quotas.mdx) and [AWS](cmp/amazon-web-services/aws-quotas.mdx) you can stay on top of your cloud quotas with proactive monitoring. You'll get notified when you're approaching quotas.
...
[Cloud cost anomaly detection](cmp/anomaly-detection/cloud-anomalies.mdx) offers end-to-end **autonomous monitoring** of spikes in your AWS & Google Cloud usage & billing, seamlessly, across all your projects and services.
...
- Create [consulting and support requests](cmp/services/consulting-support/)
- [Escalate](cmp/services/consulting-support/escalate.mdx) support requests
- [Share](cmp/services/consulting-support/ticket-sharing.mdx) support requests with others
- Get access to exclusive [training](cmp/services/training.mdx), [professional services](cmp/services/proserv.mdx), and [perks](cmp/services/perks.mdx)

<LoomEmbed id="ec2e0bca53fc46ef80061dd96be2f1a0" />
...
- [Create a new Google Cloud Billing Account](cmp/google-cloud/create-google-cloud-billing-account.mdx) and/or an [AWS account](cmp/amazon-web-services/create-an-aws-account.mdx).
- [Invite an existing AWS account](cmp/amazon-web-services/invite-existing-aws-account.mdx)
- [Purchase additional seats for G Suite](cmp/g-suite-and-workspace/purchasing-g-suite-licenses.mdx) and/or [Office 365](cmp/microsoft-office-365/purchasing-office-365-licenses.mdx) yourself.
- Automate subscription management with [auto-provisioning](cmp/g-suite-and-workspace/configure-auto-increase-for-google-workspace-subscriptions.mdx) for G Suite, guaranteeing there is an open seat at all times.
- [Tag Assets](cmp/assets-and-contracts/tag-assets.mdx) for classification and invoicing purposes (e.g. team name, cost center, location, etc.).
...
[**Billing Profiles**](cmp/invoices-and-payments/setting-up-a-new-billing-profile.mdx) are for when your company has different entities requiring separate invoices. For instance, you may use a different payment method or currency depending on the entity.
...
[**Invoices**](cmp/invoices-and-payments/managing-invoices.mdx) across all cloud platforms and their current statuses can be easily accessed using the CMP.
...
[**Invoice Bucketing**](cmp/invoices-and-payments/changing-invoice-settings.mdx) lets you create custom "buckets" and assign specific assets to those buckets.
...
[Go here](cmp/invoices-and-payments/managing-invoices.mdx) for the full list of your billing and payment-related capabilities.
...
- [Add colleagues](cmp/user-management/creating-a-new-user.mdx) to your CMP team.
- Management Billing Profile assignments.
- Configure notifications for alerts like payment reminders, new invoices, and more.
- [Set up and grant roles](cmp/user-management/manage-roles.mdx) that give access to various CMP features.
...
- [Open tickets](cmp/services/consulting-support/) with experienced Cloud Architects and Engineers.
- View open or historical tickets and their statuses.
- [Share tickets](cmp/services/consulting-support/ticket-sharing.mdx) with other team members.
- Stay up to date on any [known issues](cmp/services/consulting-support/cloud-incidents.mdx) across all clouds you use.
