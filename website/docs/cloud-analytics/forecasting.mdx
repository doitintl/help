...
![A screenshot showing you the _ML Features_ drop-down](../../static/img/docs/cmp-report-ml-menu.png)
...
![A screenshot of a forecast report](../../static/img/docs/cmp-report-ml-forecast.png)
...
<LoomEmbed id="51439d799674427eba2b2f3a7b26cd87" />
