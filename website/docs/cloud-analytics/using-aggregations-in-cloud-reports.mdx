...
![A screenshot showing a Total aggregation report](../../static/img/docs/cmp-report-aggregation-total.png)
...
![A screenshot showing a % of Total aggregation report](../../static/img/docs/cmp-report-aggregation-pct-total.png)
...
![A screenshot showing a & of Column aggregation report](../../static/img/docs/cmp-report-aggregation-pct-col.png)

## % of Row

"% of Row" aggregations display cell values as a percentage of its row, with each row being represented as 100% in totality.

![A screenshot showing a % of Row aggregation report](../../static/img/docs/cmp-report-aggregation-pct-row.png)
...
![A screenshot showing a Cost/Usage aggregation report](../../static/img/docs/cmp-report-aggregation-unit-cost.png)
