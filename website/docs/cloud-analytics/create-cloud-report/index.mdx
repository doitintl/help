...
Please connect your [Google Cloud Organization](../../google-cloud/connect-google-cloud-service-account.mdx) or [Amazon Web Services](../../amazon-web-services/invite-existing-aws-account.mdx) to the Cloud Management Platform to get all available features.
