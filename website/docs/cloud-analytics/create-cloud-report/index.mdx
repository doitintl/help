...
# Creating Cloud Analytics reports
...
Please connect your [Google Cloud Organization](../../google-cloud/connect-google-cloud-service-account.mdx) or [Amazon Web Services](https://app.gitbook.com/@doitintl/s/cmp/amazon-web-services/add-your-amazon-web-services-iam-role) to the Cloud Management Platform to get all available features.

:::

## Accessing reports

To access your Cloud Analytics reports, select _Reports_ from the _Analytics_ menu item on the top navigation bar:
...
You can [configure a default timezone for new Cloud Analytics reports in General > Settings](../../general/general-settings.mdx#timezone)

## Watch

View the bite-sized video below for a closer look at creating and exploring Cloud Analytics reports:
