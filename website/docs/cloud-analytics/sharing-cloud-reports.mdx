...
![A screenshot showing the location of the Share Report modal dialog](../assets/cmp-share-report-demo.gif)
...
<Image
  ...
  img={require('../assets/email-invitation.png')}
/>
...
![A screenshot showing the Share Report modal dialog](../assets/cmp-share-report-dialog.png)
