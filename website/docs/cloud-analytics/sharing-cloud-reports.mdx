...
If you're new to Cloud Analytics reports or haven't created a report yet, we recommend reading our post on Creating Cloud Analytics reports](create-cloud-report/index.mdx) before reading further.
...
![A screenshot showing the location of the Share Report modal dialog](../assets/gif/cmp-share-report-demo.gif)

Once a report is shared, the recipient(s) will receive an email that looks like this:

![A screenshot showing an invitation email](../assets/png/email-invitation.png)
...
![A screenshot showing the Share Report modal dialog](../assets/png/cmp-share-report-dialog.png)
