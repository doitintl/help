...
<picture
  img={require('../../assets/gif/cmp-share-report-demo.gif')}
  alt="A screenshot showing the location of the Share Report modal dialog"
/>

Once a report is shared, the recipient(s) will receive an email that looks like this:

<picture
  img={require('../../assets/png/email-invitation.png')}
...
<picture
  img={require('../../assets/png/cmp-share-report-dialog.png')}
  alt="A screenshot showing the Share Report modal dialog"
/>
