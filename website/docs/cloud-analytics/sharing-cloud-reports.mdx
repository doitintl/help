...
If you're new to Cloud Reports or haven't created a Cloud Report yet, we recommend reading our post on [**Creating Cloud Reports**](create-cloud-report/index.mdx) before reading further.
...
![A screenshot of an example report](../../static/img/docs/cmp-example-report.png)
...
![A screenshot showing the location of the Share Report modal dialog](../../static/img/docs/cmp-share-report-demo.gif)

Once a report is shared, the recipient(s) will receive an email that looks like this:

![A screenshot showing an invitation email](../../static/img/docs/email-invitation.png)
...
![A screenshot showing the Share Report modal dialog](../../static/img/docs/cmp-share-report-dialog.png)
