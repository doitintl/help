...
![A screenshot of the Metric input](../assets/png/cmp-metric-input.png)

![A screenshot of the search menu](../assets/png/cmp-search-menu.png)
...
![Metric Configuration Window](../assets/png/cmp-metric-configuration-window.png)
...
![A screenshot of the Metric filter form](../assets/png/cmp-metric-filter-form.png)

When applied a filter chip will appear in the metric bar:

![A screenshot of the operators drop-down menu](../assets/png/cmp-operators-menu.png)
...
![A screenshot of the Metric filter chip](../assets/png/cmp-metric-filter-chip.png)
