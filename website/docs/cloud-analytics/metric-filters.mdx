...
![A screenshot of the Metric input](../assets/cmp-metric-input.png)

import Image from '@theme/IdealImage';

<Image
  alt="A screenshot of the search menu"
  img={require('../assets/cmp-search-menu.png')}
/>
...
<Image
  ...
  img={require('../assets/cmp-metric-configuration-window.png')}
/>
...
![A screenshot of the Metric filter form](../assets/cmp-metric-filter-form.png)

When applied a filter chip will appear in the metric bar:

![A screenshot of the operators drop-down menu](../assets/cmp-operators-menu.png)
...
![A screenshot of the Metric filter chip](../assets/cmp-metric-filter-chip.png)
