...
![A screenshot of the Metric input](../../static/img/docs/cmp-metric-input.png)

![A screenshot of the search menu](../../static/img/docs/cmp-search-menu.png)
...
![Metric Configuration Window](../../static/img/docs/cmp-metric-configuration-window.png)
...
![A screenshot of the Metric filter form](../../static/img/docs/cmp-metric-filter-form.png)

When applied a filter chip will appear in the metric bar:

![A screenshot of the operators drop-down menu](../../static/img/docs/cmp-operators-menu.png)
...
![A screenshot of the Metric filter chip](../../static/img/docs/cmp-metric-filter-chip.png)
