...
![A screenshot showing an example report](../../static/img/docs/cmp-example-report.png)
...
![A screenshot showing the Schedule Report Email Delivery modal dialog](../../static/img/docs/cmp-schedule-report-email-dialog.png)
...
![A screenshot showing the Some recipients need access to this report modal dialog](../../static/img/docs/cmp-some-recipients-need-access-dialog.png)
...
![A screenshot showing the Some recipients need access to this report modal dialog](../../static/img/docs/cmp-recipients-need-access-dialog.png)
...
![A screenshot showing the location of the Open Live Report button](../../static/img/docs/cmp-open-live-report-button.png)
...
![A screenshot of the _Reports_ screen](../../static/img/docs/cmp-analytics-reports.png)
...
![A screenshot showing the Schedule Report Email Delivery dialog](../../static/img/docs/cmp-schedule-report-delivery-dialog.png)
