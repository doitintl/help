...
If you're new to budgets and/or aren't familiar with Attributions we recommend reading our post on [_Creating Attributions_](attributing-cloud-spend.mdx) before reading further.
...
Within the Cloud Management Platform, you can set budgets using [Attributions](attributing-cloud-spend.mdx), custom-defined groupings of cloud resources (accounts, services, etc.) that map to your organizational and financial reporting structure.
...
<Image
  alt="A screenshot of the _Budgets_ page"
  img={require('../../static/img/docs/cmp-budget-screen.png')}
/>
...
<Image
  alt="A screenshot of the new budget form"
  img={require('../../static/img/docs/cmp-new-budget.png')}
/>

Give your budget a suitable name and the budget's scope by selecting the attributions your budget will be allocated to.

As mentioned elsewhere, [attributions](attributing-cloud-spend.mdx) let you group any combination of cloud resources (and their associated costs) so you can better relate cloud costs to your financial reporting structure.
...
<Image
  alt="A screenshot of a budget preview"
  img={require('../../static/img/docs/cmp-budget-preview.png')}
/>
...
In order to see forecasted dates for budget thresholds, you need to click the "Refresh" button after setting a budget amount.
...
<Image
  ...
  img={require('../../static/img/docs/email-budget-alert.png')}
/>
...
<LoomEmbed id="3588cdf27fd84f7fab8e96ea91b7d7f9" />
