...
![A screenshot of the _Budgets_ page](../../static/img/docs/cmp-budget-screen.png)
...
![A screenshot of the new budget form](../../static/img/docs/cmp-new-budget.png)
...
![A screenshot of a budget preview](../../static/img/docs/cmp-budget-preview.png)
...
![A screenshot showing an email alert](../../static/img/docs/email-budget-alert.png)
