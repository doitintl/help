...
If you're new to Cloud Reports and/or haven't created a Cloud Report yet, we recommend reading our post on [Creating Cloud Reports](create-cloud-report/index.mdx) before reading further.
