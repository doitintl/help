...
<Image
  ...
  img={require('../assets/cmp-example-report.png')}
/>
...
![A screenshot showing you the options for Time Range](../assets/cmp-time-range-options.png)
...
![A screenshot of the Time Range drop-down menu](../assets/cmp-time-range-menu.png)
...
![A screenshot of the Comparative data drop-down menu](../assets/cmp-comparative-data-menu.png)
...
<Image
  ...
  img={require('../assets/cmp-show-comparative-report-dialog.png')}
/>
...
<Image
  ...
  img={require('../assets/cmp-report-highlighted-columns.png')}
/>
...
![A screenshot showing you the location of the Save button](../assets/cmp-cloudreports-filters.png)
