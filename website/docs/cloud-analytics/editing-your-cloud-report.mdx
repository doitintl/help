...
# Editing your Cloud Analytics Report

:::tip

If you're new to Cloud Analytics reports and/or haven't created a report yet, we recommend reading our post on [Creating Cloud Analytics reports](create-cloud-report/index.mdx) before reading further.

:::

An example cloud analytics report:

![A screenshot showing and example report](../assets/png/cmp-example-report.png)
...
![A screenshot showing you the options for Time Range](../assets/png/cmp-time-range-options.png)
...
![A screenshot of the Time Range drop-down menu](../assets/png/cmp-time-range-menu.png)
...
![A screenshot of the Comparative data drop-down menu](../assets/png/cmp-comparative-data-menu.png)
...
![A screenshot of the Show Comparative Report modal dialog](../assets/png/cmp-show-comparative-report-dialog.png)

Once enabled, you will see new columns in your table based view showing the &delta; between time intervals. This difference (&delta;) appears **after** the intervals compared.

For example below: Months 07 (July) and 08 (August) show the % change after in the column &delta;08 (Change to August)

![Report with highlighted comparison columns](../assets/png/cmp-report-highlighted-columns.png)

_Note: Column headings will contain a % symbol when showing % change_

### Filtering Values

You can filter the metric included in the report by using an [Metric Filter](metric-filters.mdx)
...
![A screenshot showing you the location of the Save button](../assets/png/cmp-cloudreports-filters.png)
...
- Chart type
- Sorting of results
- ML Features such as [Trend Analysis](trend-analysis.mdx) or [Forecasting](forecasting.mdx)
