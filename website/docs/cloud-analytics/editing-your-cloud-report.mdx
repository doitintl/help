...
![A screenshot showing and example report](../../static/img/docs/cmp-example-report.png)
...
![A screenshot showing you the options for Time Range](../../static/img/docs/cmp-time-range-options.png)
...
![A screenshot of the Time Range drop-down menu](../../static/img/docs/cmp-time-range-menu.png)
...
![A screenshot of the Comparative data drop-down menu](../../static/img/docs/cmp-comparative-data-menu.png)
...
![A screenshot of the Show Comparative Report modal dialog](../../static/img/docs/cmp-show-comparative-report-dialog.png)
...
![Report with highlighted comparison columns](../../static/img/docs/cmp-report-highlighted-columns.png)
...
![A screenshot showing you the location of the Save button](../../static/img/docs/cmp-cloudreports-filters.png)
