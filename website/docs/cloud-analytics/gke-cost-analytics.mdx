...
- [Forecast](reports/forecasting.mdx) and [identify trends](reports/trend-analysis.mdx) across any/all K8s primitives in one click.
...
Once everything is set up, your team's GKE metering data can be analyzed using the CMP's [Cloud Analytics](reports/index.mdx) functionality.
...
<picture
  img={require('../../assets/png/cmp-gke-labels-dropdown.png')}
