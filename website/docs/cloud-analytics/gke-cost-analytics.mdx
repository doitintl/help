...
<Image
  ...
  img={require('../assets/cmp-gke-cost-analytics-enable.png')}
/>
...
<Image
  ...
  img={require('../assets/gcp-share-dataset-button.png')}
/>
...
<Image
  ...
  img={require('../assets/gcp-grant-bigquery-data-view-role.png')}
/>
...
<Image
  ...
  img={require('../assets/cmp-gke-dimensions.png')}
/>

You will also find any GKE labels in the Labels chip, under the "GKE Labels" header in the dropdown.

![A screenshot showing the GKE Labels dropdown](../assets/cmp-gke-labels-dropdown.png)
