...
![A screenshot showing you the location of the location of the Upload Key button](../assets/png/cmp-gke-cost-analytics-enable.png)
...
![A screenshot showing you the location of the Share Dataset button](../assets/png/gcp-share-dataset-button.png)
...
![A screenshot showing how to grant the BigQuery Data Viewer role](../assets/png/gcp-grant-bigquery-data-view-role.png)
...
![A screenshot showing the GKE dimensions](../assets/png/cmp-gke-dimensions.png)

You will also find any GKE labels in the Labels chip, under the "GKE Labels" header in the dropdown.

![A screenshot showing the GKE Labels dropdown](../assets/png/cmp-gke-labels-dropdown.png)
