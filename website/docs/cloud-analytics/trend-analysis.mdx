...
<picture
  img={require('../../assets/png/cmp-report-ml-menu.png')}
  alt="A screenshot showing you the _ML Features_ drop-down"
/>
...
<picture
  img={require('../../assets/png/cmp-report-ml-trend.png')}
  alt="A screenshot of a trending up report"
/>
...
<video
  type="loom"
  id="e2b7381983fa41bb929436a1d4a1e30b"
  thumb="-00001.gif"
/>
