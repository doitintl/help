...
![A screenshot of the Attributions screen](../assets/png/cmp-attributions-screen.png)
...
![A screenshot showing the location of the items listed above](../assets/png/cmp-all-any.png)
...
![A screenshot showing the dropdown menu](../assets/png/cmp-attributions.png)
...
![A screenshot showing the Filter Projects form](../assets/png/cmp-filter-projects-form.png)
...
![A screenshot of the attribution list with a 3-dot menu on each line](../assets/png/cmp-attribution-list-menu.png)

As the owner of an attribution you will see several option:

![A screenshot of the 3-dot menu options](../assets/png/cmp-attribution-list-menu-options.png)
...
![A screenshot of the Attributions Settings panel](../assets/png/cmp-attributions-settings.png)
...
![A screenshot showing the Filter attributions form](../assets/png/cmp-filter-attributions-form.png)
