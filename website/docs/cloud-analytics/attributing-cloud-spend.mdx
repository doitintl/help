...
<Image
  ...
  img={require('../assets/cmp-attributions-screen.png')}
/>
...
<Image
  ...
  img={require('../assets/cmp-all-any.png')}
/>
...
![A screenshot showing the dropdown menu](../assets/cmp-attributions.png)
...
![A screenshot showing the Filter Projects form](../assets/cmp-filter-projects-form.png)
...
<Image
  ...
  img={require('../assets/cmp-attribution-list-menu.png')}
/>

As the owner of an attribution you will see several option:

![A screenshot of the 3-dot menu options](../assets/cmp-attribution-list-menu-options.png)
...
<Image
  ...
  img={require('../assets/cmp-attributions-settings.png')}
/>
...
![A screenshot showing the Filter attributions form](../assets/cmp-filter-attributions-form.png)
