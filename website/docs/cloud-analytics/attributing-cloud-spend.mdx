...
![A screenshot of the Attributions screen](../../static/img/docs/cmp-attributions-screen.png)
...
![A screenshot showing the location of the items listed above](../../static/img/docs/cmp-all-any.png)
...
![A screenshot of the attribution list with a 3-dot menu on each line](../../static/img/docs/cmp-attribution-list-menu.png)
...
![A screenshot of the Attributions Settings panel](../../static/img/docs/cmp-attributions-settings.png)
