...
<Image
  ...
  img={require('../../static/img/docs/cmp-metrics-screen.png')}
/>
...
<Image
  ...
  img={require('../../static/img/docs/cmp-new-metric.png')}
/>
...
To include a metric in a report, [create a new report](create-cloud-report/index.mdx).
