...
![A screenshot showing the Metrics screen](../../static/img/docs/cmp-metrics-screen.png)

To create a new metric, select the _New Metric_ button to access the _New Metric_ screen:

![A screenshot showing the _New Metric_ screen](../../static/img/docs/cmp-new-metric.png)
