...
- [Metric selection documentation](reports/editing-your-cloud-report.mdx#metric).
...
<picture
  img={require('../../assets/png/cmp-metrics-screen.png')}
  alt="A screenshot showing the Metrics screen"
/>

To create a new metric, select the _New Metric_ button to access the _New Metric_ screen:

<picture
  img={require('../../assets/png/cmp-new-metric.png')}
  alt="A screenshot showing the _New Metric_ screen"
/>
...
To include a metric in a report, [create a new report](reports/create-report.mdx).
